...
const LINUX_FILES = [`DubXNet-${VERSION}-i386.AppImage`, `DubXNet-${VERSION}-x86_64.AppImage`];
const WINDOWS_FILES = [`DubXNet Setup ${VERSION}.exe`, `DubXNet Setup ${VERSION}.exe.blockmap`];
const OSX_FILES = [`DubXNet-${VERSION}-mac.zip`, `DubXNet-${VERSION}.dmg`, `DubXNet-${VERSION}.dmg.blockmap`];
const FLAVOR = (() => {
